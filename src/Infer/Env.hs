...
initialEnv = Env
  { envvars        = M.fromList
    ...
    -- , ("||", Forall [] $ TCon CBool `TApp` TCon CBool `TApp` TCon CBool)
    -- , ("!" , Forall [] $ TCon CBool `TApp` TCon CBool)
    -- , ( ">"
    --   , Forall [TV "a"] $ TVar [] (TV "a") `TApp` TVar [] (TV "a") `TApp` TCon CBool
    --   )
    -- , ( "<"
    --   , Forall [TV "a"] $ TVar [] (TV "a") `TApp` TVar [] (TV "a") `TApp` TCon CBool
    --   )
    ...
    --   , Forall [TV "a"] $ TVar [] (TV "a") `TApp` TVar [] (TV "a") `TApp` TCon CBool
    --   )
    -- , ("++", Forall [] $ TCon CString `TApp` TCon CString `TApp` TCon CString)
    , ("+" , Forall [] $ [] :=> (tNumber `fn` tNumber `fn` tNumber))
    -- , ("-" , Forall [] $ TCon CNum `TApp` TCon CNum `TApp` TCon CNum)
    -- , ("*" , Forall [] $ TCon CNum `TApp` TCon CNum `TApp` TCon CNum)
    -- , ("/" , Forall [] $ TCon CNum `TApp` TCon CNum `TApp` TCon CNum)
    -- , ("%" , Forall [] $ TCon CNum `TApp` TCon CNum `TApp` TCon CNum)
    -- , ( "|>"
    --   , Forall [TV "a", TV "b"]
    --   $      TVar [] (TV "a")
    --   `TApp` (TVar [] (TV "a") `TApp` TVar [] (TV "b"))
    --   `TApp` TVar [] (TV "b")
    --   )
    -- , ( "asList"
    --   , Forall [TV "a"] $ TApp (TVar [] $ TV "a") $ TComp "Prelude"
    --                                                    "List"
    --                                                    [TVar [] $ TV "a"]
    --   )
    -- , ( "List"
  ...
  , envtypes = M.empty -- M.fromList [("List", TComp "Prelude" "List" [TVar [] $ TV "a"])]
  , envimports     = M.empty
  , envinterfaces = []
  , envinstances = []
  , envcurrentpath = ""
...
addConstraints interfaceName var t = case t of
  ...
  TApp l r -> TApp (addConstraints interfaceName var l) (addConstraints interfaceName var r)
  _ -> t
